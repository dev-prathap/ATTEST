...
through a [private security advisory](https://github.com/dev-prathap/ATTEST/security/advisories/new),
which is the private channel available on this repository. All complaints will be reviewed and
investigated promptly and fairly, and the reporter's privacy and security will be respected.
...
This code applies within all project spaces, and also when an individual is officially representing the

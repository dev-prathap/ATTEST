...
`packages/attest-ts` — `@attest/sdk`. Same contract, ledger format and hash chain as Python; a test fixture
...
Adapters: `@attest/sdk/adapters/vercel` (`attestedTools`), `/langchain` (`wrapTools` for LangChain.js tools),
